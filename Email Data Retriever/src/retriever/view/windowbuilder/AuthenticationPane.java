...
public class AuthenticationPane extends JPanel implements MessageListener{
	...
	public AuthenticationPane(EmailDataRetriever parent, ImapAuthenticator authenticator) {
		...
		String[] possibleImapServers = {"imap.gmail.com"};//, "outlook.unc.edu"};
		...
		gl_credentials.setHorizontalGroup(
			gl_credentials.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_credentials.createSequentialGroup()
					.addGroup(gl_credentials.createParallelGroup(Alignment.LEADING)
					...
					.addGap(3)
					.addGroup(gl_credentials.createParallelGroup(Alignment.LEADING)
						.addComponent(emailAddress, GroupLayout.DEFAULT_SIZE, 205, Short.MAX_VALUE)
						.addComponent(password, GroupLayout.DEFAULT_SIZE, 205, Short.MAX_VALUE)
						.addGroup(gl_credentials.createSequentialGroup()
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addGroup(gl_credentials.createParallelGroup(Alignment.LEADING)
								.addComponent(smtpServer, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 205, Short.MAX_VALUE)
								.addComponent(imapServer, 0, 204, Short.MAX_VALUE)))))
		);
		gl_credentials.setVerticalGroup(
			gl_credentials.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_credentials.createSequentialGroup()
					.addGroup(gl_credentials.createParallelGroup(Alignment.LEADING)
						.addComponent(imapServerLabel)
						.addComponent(imapServer, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_credentials.createParallelGroup(Alignment.LEADING)
						.addComponent(smtpServerLabel)
						.addComponent(smtpServer, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_credentials.createParallelGroup(Alignment.LEADING)
						.addComponent(emailAddressLabel)
		...
		progressMessage = new JLabel("Message 0 of "+ImapThreadRetriever.MAX_MESSAGES);
				...
				.addGroup(groupLayout.createSequentialGroup()
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(Alignment.TRAILING, groupLayout.createParallelGroup(Alignment.LEADING)
							.addComponent(lblMessagesRetrieved, GroupLayout.DEFAULT_SIZE, 274, Short.MAX_VALUE)
							.addComponent(logPanel, GroupLayout.DEFAULT_SIZE, 274, Short.MAX_VALUE)
							.addGroup(groupLayout.createSequentialGroup()
								.addContainerGap()
								.addComponent(progressBar, GroupLayout.DEFAULT_SIZE, 264, Short.MAX_VALUE))
							.addComponent(credentials, GroupLayout.DEFAULT_SIZE, 274, Short.MAX_VALUE))
						.addComponent(submitPanel, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addGroup(groupLayout.createSequentialGroup()
							.addContainerGap()
		...
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addComponent(credentials, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(submitPanel, GroupLayout.PREFERRED_SIZE, 32, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(lblMessagesRetrieved, GroupLayout.PREFERRED_SIZE, 14, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
		...
		gl_logPanel.setHorizontalGroup(
			gl_logPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_logPanel.createSequentialGroup()
					.addGap(6)
					.addComponent(textAreaPane, GroupLayout.DEFAULT_SIZE, 268, Short.MAX_VALUE))
				.addGroup(Alignment.TRAILING, gl_logPanel.createSequentialGroup()
		...
		gl_logPanel.setVerticalGroup(
			gl_logPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_logPanel.createSequentialGroup()
					...
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(textAreaPane, GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE))
		);
	...
	public void updateRetrievedMessageCounts(int latestRetrieved){
		...
		progressMessage.setText("Message "+latestRetrieved+" of "+ImapThreadRetriever.MAX_MESSAGES);
	}
