...
public class SendPane extends JPanel {
	...
	public SendPane(EmailDataRetriever parent, String addressToSendTo) {
		...
		JLabel sentDescription = new JLabel("<html>The following data will be sent to "+addressToSendTo+"<html>");
				...
				.addGroup(gl_dataPanel.createSequentialGroup()
					.addGroup(gl_dataPanel.createParallelGroup(Alignment.TRAILING)
						.addGroup(Alignment.LEADING, gl_dataPanel.createSequentialGroup()
							.addContainerGap()
							.addComponent(textAreaPane, GroupLayout.DEFAULT_SIZE, 255, Short.MAX_VALUE))
						.addComponent(includeFullEmailAddresses, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 265, Short.MAX_VALUE)
						.addComponent(includeSubjects, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 265, Short.MAX_VALUE)
						.addGroup(gl_dataPanel.createSequentialGroup()
							.addComponent(emailAddressLabel)
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(emailAddress, GroupLayout.DEFAULT_SIZE, 231, Short.MAX_VALUE))
						.addComponent(lblSentData, Alignment.LEADING)
						.addGroup(gl_dataPanel.createSequentialGroup()
	...
	public void updateDataToSend() throws MessagingException{
		if(data != null){
			textToSend.setText(data.getDataString(emailAddress.getText(), includeSubjects.isSelected(), includeFullEmailAddresses.isSelected()));
		}else{
			textToSend.setText("");
		}
	}
