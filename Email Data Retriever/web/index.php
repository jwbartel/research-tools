...
Message:5 Thread:4 From:[7] Recipients:[2] Date:Thu Jan 09 15:08</textarea>
	...
	<div class='section-border'>
		<div class='section-label'><strong>Login</strong></div>
		<div id="retriever-form">

			<table>
				<tr>
					<!--						<td>Email Service</td>-->
					<td class='email-input' id="imap"><input class="selector" type="hidden" name="service" ">
						<!--                            <input class="selector" type="radio" name="service" onclick="displayOutlook();"> Outlook or Live Mail</td>-->

				</tr>
				<!--					<tr>-->
				<!--						<td>Email or Username</td>-->
				<td class='email-input'><input type="hidden" style="display:none" id='username' ></td>
				<!--					</tr>-->
				<tr>
					<!--						<td class="outlook" style="display:none" >Password</td>-->
											<td class="outlook" style="display:none" class='email-input'><input  id='password' type="password" >
											</td>
<!--					<td class="gmail" style="display:none"></td>-->
					<td class="gmail" style="display:none"><a id="gmail-link"
															  href=""
						><img src="img/google_login.png" width="200"></a>
						<script>
							var redirect_url;
			...
			<div id="settings" class='section-border' style='border-width: 0px'>
